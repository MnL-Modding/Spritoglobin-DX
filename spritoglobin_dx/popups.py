...
class GifExportWindow(QtWidgets.QDialog):
    def __init__(self, parent, current_window_icon, success_jingle, obj_data, renderer, use_low_framerate, initial_object, initial_animation, initial_color_anim):
        ...
        settings_layout.addWidget(self.framerate_choose_box, 2, 0, 1, 2)
        settings_layout.addWidget(self.color_anim_list_box, 4, 0, 1, 4)
        settings_layout.addWidget(self.speed_controller, 6, 0, 1, 2)
        settings_layout.addWidget(self.scale_controller, 6, 2, 1, 2)
        settings_layout.addWidget(self.anim_list_box, 8, 0, 1, 4)
        settings_layout.addWidget(self.add_button, 9, 0)
        settings_layout.addWidget(self.remove_button, 9, 1)
        settings_layout.addWidget(self.move_up_button, 9, 2)
        settings_layout.addWidget(self.move_down_button, 9, 3)
        ...
        settings_layout.addWidget(line, 11, 0, 1, 4)

        layout.addWidget(settings, 0, 0)
        layout.addWidget(self.gif_preview, 0, 1)
        layout.addWidget(self.gif_timer_text, 1, 1, alignment = QtCore.Qt.AlignmentFlag.AlignRight)
        layout.addWidget(self.export_button, 1, 0, alignment = QtCore.Qt.AlignmentFlag.AlignCenter)
